...
public class JwtService {
	private static final String ADDRESSMANAGER = "Addressmanager";
	private static final String TransportMANAGER = "Transportmanager";

	private static final String AUTH = "auth";
	private Algorithm alg = Algorithm.HMAC256("mysecret");
	private String issuer = "TransportPlanApp";
